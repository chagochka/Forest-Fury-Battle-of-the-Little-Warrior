...
class UI:
    ...
    def write_stats(self, monsters):
        ...
        if monsters.diff == 'boss':
            ...
            pygame.draw.rect(self.window, '#222222', (
                (monsters.x + monsters.texture.get_width() / 2) - monsters.max_hp / 2 - 64, monsters.y - 30 - 64, monsters.max_hp,
                15))
            pygame.draw.rect(self.window, (0, 150, 100), (
                (monsters.x + monsters.texture.get_width() / 2) - monsters.hp / 2 - 64, monsters.y - 30 - 64, monsters.hp, 15))
            pygame.draw.rect(self.window, '#111111', (
                (monsters.x + monsters.texture.get_width() / 2) - monsters.max_hp / 2 - 64, monsters.y - 30 - 64, monsters.max_hp,
                15), 3)
